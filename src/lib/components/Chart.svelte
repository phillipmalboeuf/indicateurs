...
<script lang="ts">
  ...
  function createChart() {
    ...
    switch (type) {
      case 'Histogramme':
        chart = createHistogramme(element, dataFiltered, minimum, maximum, titreDeLaxe, couleur, getLocale())
        break

      case 'Courbe':
        chart = createCourbe(element, dataFiltered, minimum, maximum, titreDeLaxe, couleur, getLocale())
        break

      case 'Pyramide':
        chart = createPyramide(element, dataFiltered, minimum, maximum, titreDeLaxe, couleur, getLocale())
        break
      
      case 'Tarte':
        chart = createTarte(element, dataFiltered, minimum, maximum, titreDeLaxe, couleur, getLocale())
        break
