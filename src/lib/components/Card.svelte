...
<article>
  ...
  <em style="color: {indicateur.fields.categorie?.fields?.couleur}"><a href="{getLocale() === 'en' ? "/en" : ""}/categories/{indicateur.fields.categorie?.fields?.id}">{indicateur.fields.categorie?.fields?.titre}</a></em><br />
  {/if}
  <a class="indicateurs" href="{getLocale() === 'en' ? "/en" : ""}/indicateurs/{indicateur.fields.id}">{indicateur.fields.titre}</a>
  ...
  <aside>
    <a href="{getLocale() === 'en' ? "/en" : ""}/indicateurs/{indicateur.fields.id}"><small>{getLocale() === 'en' ? "Details" : "Détails"}&nbsp;<Icon i="chevron" small /></small></a>
    <div>
